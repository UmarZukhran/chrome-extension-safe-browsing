...
//   });
  ...
  function downloadExcel() {
      chrome.runtime.sendMessage({ type: 'getMaliciousUrls' }, (response) => {
          const maliciousUrls = response.maliciousUrls;
          const worksheet = XLSX.utils.json_to_sheet(maliciousUrls);
          const workbook = XLSX.utils.book_new();
          XLSX.utils.book_append_sheet(workbook, worksheet, 'Malicious URLs');
          XLSX.writeFile(workbook, 'Malicious_URLs.xlsx');
      });
  }  